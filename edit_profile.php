...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Biobook"><b>Instanow</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
		...
		<fieldset class="---------------">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="number" value="<?php echo $number; ?>" placeholder="09...." maxlength="10" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
<br />		
